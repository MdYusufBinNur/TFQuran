...
@section('body')
                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-4  text-right" >
                                        <a class="" href="{{ route('add_new_category') }}">
                                        ...
                                        @foreach($categories as $category)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    &nbsp;
                                                    <a class="btn-floating btn-sm btn-danger ts-delete-al"  data-target="#category_delete" data-toggle="modal" onclick="delete_category({{ $category->id }})"  title="Delete"><i class="fas fa-times"></i></a>
            ...
            <form  action="{{ route('update_category') }}" method="post">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title w-100 text-center" id="myModalLabel"><strong>Change Category Records</strong></h4>
                        ...
                        <table class="table">
                            ...
                            <tr >
                                <td>
                                    ...
                                    <input id="category_name" type="text" class="form-control" name="name" value="" required autofocus>
    ...
    <div class="modal fade " id="category_delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
