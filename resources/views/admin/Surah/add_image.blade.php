                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card card-dark">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form role="form" action="{{ url('save_image') }}" method="POST" enctype="multipart/form-data">
                                    <!-- text input -->
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Imae name" id="image_name" name="image_name" required>
                                            </div>
                                        </div>
                                    </div>
